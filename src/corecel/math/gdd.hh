...
inline CELER_FUNCTION __attribute__((optimize("fp-contract=off")))
...
static Array<gdd_real, 15> dd_inv_fact{
...
static gdd_four d_dd_sin_table{
...
static gdd_four d_dd_cos_table{
